		...
		<div className="mb-3">
			<div className="space-y-2">
				...
				<input
					...
					className="w-full rounded border input p-2 mt-3 mb-2"
				/>
				{errors.title && (
			...
			<div>
				...
				<textarea
					...
					className="w-full rounded-lg border input resize-none p-2 mt-3 mb-2"
				/>
				{errors.description && (
			...
			<div className="grid grid-cols-2 gap-4">
				<div className="grid">
					...
					<select
						id="category"
						name="category"
						className="w-full rounded border p-2 mt-3 mb-2"
